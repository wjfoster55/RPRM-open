...
All nine [executable packs](experimental/README.md) are explicitly experimental.
...
## Core recovery formalization (RCF01)

Local research home for recovered Prestige One, fiving/FIVE_IS_SAFE, and cube
concepts. This is not a tenth executable pack and not a change to the published
paper. Concept IDs in the register must not disappear in later consolidations.

- [Register and return](research/core-recovery-01/README.md)
- [Envelope experiment](experiments/core_recovery_bridge_01/README.md)
- [R1 review repair](research/core-recovery-r1/RETURN_TO_WILLIAM_R1.md): portable export and composition audit; does not restart the original recovery
- [R2 guard repair](research/core-recovery-r2/README.md): family, map-interface, and aggregate-runner guards; does not restart RCF01 or R1
