...
| [`notes/rho-ehrenfest.md`](notes/rho-ehrenfest.md) | `rho` computed on a partition nobody invented: the textbook Ehrenfest lumping. The domain condition discards ~95% of operations by `d=6`, and shape alone moves the monoid order by 10¹⁸ at fixed state and block count |
