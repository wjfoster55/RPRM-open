...
The last bracket is the obstruction: a fixed-point-free block's factor depends on
which *other* blocks carry fixed points. The count is a sum over configurations,
not a product of per-block factors, so there is no factor function for
log-convexity to be a property of and the method of Section 4 has nothing to act
on. The extremal law nevertheless holds in every case computed (466 exchanges,
$n \le 13$). We state it as a conjecture and note that a proof would need a
different mechanism.
...
| Idempotent formula | Written derivation + exhaustive validation, $n \le 6$ |
...
3. A. Caneco, V. H. Fernandes, T. M. Quinteiro, *On the monoid of partial isometries / $\mathcal{P}$-stable $\mathcal{P}$-order-preserving partial permutations*. arXiv:1905.11489.
4. S. Cicalò, V. H. Fernandes, C. Schneider, *Partial transformation monoids preserving a uniform partition*. arXiv:1210.4775.
5. V. H. Fernandes, *Normally ordered inverse semigroups*, Semigroup Forum **56** (1998), 418–433. DOI 10.1007/PL00005955. **Not obtained.**
6. H. Pei, *Equivalences, $\alpha$-semigroups and $\alpha$-congruences*, Semigroup Forum **49** (1994), 49–58. DOI 10.1007/BF02573470. Zbl 0804.20046. **Not obtained; review read.**
7. H. Pei, H. Zhou, *Semigroups of partial transformations preserving an equivalence relation*, Adv. Math. (China) (2009). **Abstract only.**
8. M. Sarkar, S. N. Singh, *On certain semigroups of transformations that preserve a partition*, Comm. Algebra **49** (2021), 331–342. arXiv:2006.04242.
9. L. Sun, *Combinatorial results for certain semigroups of transformations preserving orientation and a uniform partition*, Bull. Malays. Math. Sci. Soc. **36** (2013), 179–192.
