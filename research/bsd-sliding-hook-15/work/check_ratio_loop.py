...
analytic_interval=(F('6.38511803'),F('6.38518585'))
arithmetic_interval=(F('6.384593255'),F('6.385625424'))
assert analytic_interval[0]<=a<=analytic_interval[1]
assert arithmetic_interval[0]<=b<=arithmetic_interval[1]
...
result={'status':'RATIO_ROUNDTRIP_AND_COUNTERCASE_VERIFIED','all_81_admitted_rows':rows,
        ...
        'attributed_interval_inputs':{'A':list(map(str,analytic_interval)),
            'B1':list(map(str,arithmetic_interval)),
            'source':'research/bsd-coefficient-05/TWO_SCALES.md',
            'fresh_L_or_height_run':False},
