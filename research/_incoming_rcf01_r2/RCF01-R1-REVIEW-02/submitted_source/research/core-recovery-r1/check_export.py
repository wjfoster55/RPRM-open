#!/usr/bin/env python3
"""Package-completeness and record check for an RCF01 portable export.
...
EXECUTED_MARKERS = (
    "FINITE_TEST", "DONOR_RERUN", "WRITTEN_PROOF", "ONE_EXPLICIT",
    "INTERFACE_INVENTORY", "RELATED_CONTROLS", "EDITORIAL_NOTE", "SECONDARY",
)
...
def mutate(work: Path, control: str) -> None:
    ...
    if control == "missing-source":
        target = work / "experiments" / "core_recovery_bridge_01_r1" / "prestige_envelope.py"
        target.unlink()
        return
