...
(relative output-dir; replay still used packaged code).

Corrected portable ZIP `research/core-recovery-r1/dist_02/RCF01-portable-r1.zip`
SHA-256 `53d1e8761aeca98d26cb3732150af7a31ed109aad4e1c9187b3e4dc192315cea`.
Second clean-room extract `C:\Users\bkbee\Downloads\RCF01-portable-r1_cleanroom_02`:
`python -B run_portable.py --output-dir runs/cleanroom_02` overall exit 0, with
`portable_summary.json`, `envelope_r1.json`, and `starter_replay.json` written
under that extract root.
